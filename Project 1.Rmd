...
We can see above that the average interval width for the Adjusted Wald interval decreases as we increase our sample size. Similar to the Wald interval, our average width is smaller for lower and higher values of $p$.
...
# Print the values found above 
wald_n15_mean_prop_captured
wald_n30_mean_prop_captured
wald_n100_mean_prop_captured
```

We can see above that for the Wald interval with a sample size of $100$, our average proportion of intervals that capture the true $p$ is approximately 0.892 or 89.2%.
...
# Print the values found above 
adjwald_n15_mean_prop_captured
adjwald_n30_mean_prop_captured
adjwald_n100_mean_prop_captured
```

We can see above that for the Adjusted Wald interval with a sample size of $100$, our average proportion of intervals that capture the true $p$ is approximately 0.96 or 96%.
...
# Print the values found above 
clopper_n15_mean_prop_captured
clopper_n30_mean_prop_captured
clopper_n100_mean_prop_captured
```

We can see above that for the Clopper-Pearson interval with a sample size of $100$, our average proportion of intervals that capture the true $p$ is approximately 0.92 or 92%.
...
# Print the values found above 
score_n15_mean_prop_captured
score_n30_mean_prop_captured
score_n100_mean_prop_captured
```

We can see above that for the Score interval with a sample size of $100$, our average proportion of intervals that capture the true $p$ is approximately 0.947 or 94.7%.
...
# Print the values found above 
rawboot_n15_mean_prop_captured
rawboot_n30_mean_prop_captured
rawboot_n100_mean_prop_captured
```

We can see above that for the bootstrap raw percentile interval with a sample size of $100$, our average proportion of intervals that capture the true $p$ is approximately 0.883 or 88.3%.
...
# Print the values found above 
tboot_n15_mean_prop_captured
tboot_n30_mean_prop_captured
tboot_n100_mean_prop_captured
```

We can see above that for the bootstrap t interval with a sample size of $100$, our average proportion of intervals that capture the true $p$ is approximately 0.865 or 86.5%.
