...
wald_df <- matrix(ncol = 6,nrow = 0, dimnames = list(NULL, c("n", "p", "avg_wdith",
...
#Empty data frame to store properties of interest
adjwald_df <- matrix(ncol = 6,nrow = 0, dimnames = list(NULL, c("n", "p", "avg_wdith",
                                                       "prop_captured", "prop_below",
                                                       "prop_above")))
...
#Empty data frame to store properties of interest
clopper_df <- matrix(ncol = 6,nrow = 0, dimnames = list(NULL, c("n", "p", "avg_wdith",
                                                       "prop_captured", "prop_below",
                                                       "prop_above")))
...
for (n in n_values){
  for (p in p_values){
      ...
      for (i in 1:N){
        y <- data[i] 
        CI <- clopper_CI(y = y, n = n, alpha = 0.05)
        lower <- CI[1]
        upper <- CI[2]
        ...
        #Storing the CI for every random sample of every
        #combination of n and p (total of N*n*p rows)
        clopper_allCIs <- rbind(clopper_allCIs, c(n, p, lower, upper))
      }
      ...
      #Storing our output into our data frame
      clopper_df <- rbind(clopper_df, c(n, p, avg_width, prop_captured, 
                                        prop_below, prop_above))
  }
}
...
#Empty data frame to store properties of interest
score_df <- matrix(ncol = 6,nrow = 0, dimnames = list(NULL, c("n", "p", "avg_wdith",
                                                     "prop_captured", "prop_below",
                                                     "prop_above")))
...
for (n in n_values){
  for (p in p_values){
      ...
      for (i in 1:N){
        y <- data[i] 
        CI <- score_CI(y = y, n = n, alpha = 0.05)
        lower <- CI[1]
        upper <- CI[2]
        ...
        #Storing the CI for every random sample of every
        #combination of n and p (total of N*n*p rows)
        score_allCIs <- rbind(score_allCIs, c(n, p, lower, upper))
      }
      ...
      #Storing our output into our data frame
      score_df <- rbind(score_df, c(n, p, avg_width, prop_captured, 
                                    prop_below, prop_above))
  }
}
